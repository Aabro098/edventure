...
final Map<String, List<String>> districtsAndMunicipalities = {
  ...
  "Rasuwa": [
    "Kalika Rural Minicipality",
    "Gosaikunda Rural Municipality",
    "Naukunda Rural Municipality",
    "Parbatikunda Rural Minicipality",
  ...
  "Pyuthan": [
    ...
    "Sworgadwary Rural Municipality"
  ],
  "Rolpa": [
    "Rolpa Municipality",
  ...
  "Bajhang": [
    ...
    "Chhabispathivera Rural Municipality",
